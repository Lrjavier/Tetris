...
class Tetromino:
    def __init__(self, tetris, current=True):
        ...
        if self.shape == "I":
            self.image = tetris.app.images[0]
        elif self.shape == "J":
            self.image = tetris.app.images[1]
        elif self.shape == "L":
            self.image = tetris.app.images[2]
        elif self.shape == "O":
            self.image = tetris.app.images[3]
        elif self.shape == "S":
            self.image = tetris.app.images[4]
        elif self.shape == "T":
            self.image = tetris.app.images[5]
        elif self.shape == "Z":
            self.image = tetris.app.images[6]
        else:
